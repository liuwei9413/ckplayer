...
function ckstyle() {
    var ck = {
        ...
        pm_advmarquee: '1,0,0,0,30,20,0,0x000000,50,0,20,1,30,2000',
        pm_glowfilter: "1,0x01485d, 100, 6, 3, 10, 1, 0, 0",
        advmarquee: escape('{font color="#FFFFFF" size="18"}注意啊！！由于点播技术限制，不定期出现播放失败的情况，这很正常！请淡定，不要躁动。有时候加载失败，请刷新重试就好，如果还是不行，就等待我们修复更新。感觉好用，请分享我们的网站给小伙伴们啊~啊~啊~~~~请不要打开视频中的任何地址,否则后果自负,请把本站加到书签!~~~{/font}'),
        mainfuntion: "",
        flashplayer: "",
